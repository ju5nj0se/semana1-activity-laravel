            ...
            <div class="card">
                <div class="card-content">
                    ...
                    <form action="{{ route('products.update', $product) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="input-field">
                            <textarea id="description" name="description" class="materialize-textarea">{{ old('description', $product->description) }}</textarea>
                        ...
                        @if ($product->image_path)
                            <div class="section">
                                <img src="{{ $product->image_path }}" alt="{{ $product->name }}" class="responsive-img" style="max-width: 120px;">
                            </div>
                        @endif
